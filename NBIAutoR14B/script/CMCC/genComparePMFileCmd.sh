...
for NETYPE in EpRpDynS1uEnb EthernetPort EutranCellTdd EutranRelationTdd ManagedElement SctpAssoc GGSN SGW PGW SGSN MME PCRF HLR HSS
do
      echo "\n---------------------------------------------------------" >> $CompareDetailFile
      ...
      do
        ...
        SGSN)
            ...
            ;;
        GGSN|HLR)
            pmfileName="CMCC-"$NETYPE"-PM-V4.0.1-"$pmfileTimestamp.xml.gz
            ;;
        MME)
            pmfileName="CMCC-"$NETYPE"-PM-V1.2.0-"$pmfileTimestamp.xml.gz
            ;;
        PCRF|PGW)
            pmfileName="CMCC-"$NETYPE"-PM-V1.3.1-"$pmfileTimestamp.xml.gz
            ;;
        SGW)
            pmfileName="CMCC-"$NETYPE"-PM-V1.3.0-"$pmfileTimestamp.xml.gz
            ;;
        HSS)
            pmfileName="CMCC-"$NETYPE"-PM-V2.1.0-"$pmfileTimestamp.xml.gz
            ;;
        *)
            pmfileName="CMCC-ENB-PM-V2.3.0-"$NETYPE"-"$pmfileTimestamp.xml.gz
            ;;
        esac
